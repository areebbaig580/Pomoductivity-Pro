...
const Timer = ({ timerState }) => {
  ...
  return (
    <div className='flex flex-col w-8/10 h-full items-center'>

      <div className='text-[15vw] text-[#8A75E6]'>{mins}:{sec}</div>
      <button className='h-fit w-fit text-[2vw] bg-[#8A75E6] px-10 py-2 rounded-2xl cursor-pointer'
        onClick={() =>
          setRunning(r => !r)}>
