        ...
        <div className='h-fit w-full md:w-5/10 '>
            <div className='px-2 flex justify-between mt-4'>
                ...
                <div>
                    ...
                    <select value={notifyMode} onChange={(e) => setNotifyMode(e.target.value)} className='mr-2 py-1 px-1 bg-text text-secondary rounded-sm'>
                    ...
                    <input type="number"
                        ...
                        className='w-15 pl-2 py-1 bg-text text-secondary rounded-sm'
                    />
                </div>
            </div>
